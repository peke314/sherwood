 ...
 *
 *
 * @file           budweiser-media
 * @package        sherwoodwebsite
 * @author         Victor Janin
 * @copyright      2016 - futur
 * @license        license.txt
 * @version        Release: 1.1
 * @filesource     wp-content/themes/sherwoodwebsite/budweiser-media.php
  ...
  <body id="budweisermedia">
    ...
    <header>
      <div class="in_section">
        <div class="logo">
          <a href="<?php echo esc_url(site_url( '/budweiser')); ?>">
        ...
        <div class="nav">
          ...
          <ul>
            <li><a href="<?php echo esc_url(site_url( '/budweiser')); ?>#about">About</a></li>
            <li><a href="<?php echo esc_url(site_url( '/budweiser')); ?>#gallery">Gallery</a></li>
            <li><a href="<?php echo esc_url(site_url( '/budweiser')); ?>#history">History</a></li>
            <li><a href="<?php echo esc_url(site_url( '/budweiser')); ?>#facts">Facts</a></li>
            <li><a href="<?php echo esc_url(site_url( '/budweiser')); ?>#icon">Icon</a></li>
            <li><a href="<?php echo esc_url(site_url( '/budweiser')); ?>#footer_container">Contact</a></li>
