 ...
 * @license        license.txt
 * @version        Release: 1.1
 * @filesource     wp-content/themes/sherwoodwebsite/media.php
    ...
    <header>
      <div class="in_section">
        ...
        <div class="nav">
          ...
          <ul>
            ...
            <li><a href="<?php echo esc_url(site_url( '/')); ?>#facts">Facts</a></li>
            <li><a href="<?php echo esc_url(site_url( '/')); ?>#icon">Icon</a></li>
            <li><a href="<?php echo esc_url(site_url( '/')); ?>#footer_container">Contact</a></li>
     ...
     <section id="mediaWrapper-Wrapper">
      ...
      <div id="mediaWrapper">
        ...
        <?php if(get_field('media', 'options')): ?>
              <?php while(has_sub_field('media', 'options')): ?>
